let
  improvedRasi = ''
    ...
    * {
      ...
      background-color: #5628d434; // biru-abu gelap transparan
      border-radius: 24px;
      padding: 0px;
    }
    ...
    element selected {
      background-color: #3f3e80af; // biru highlight transparan
      border-radius: 10px;
      text-color: #cdd6f4;
    }
    element-icon {
